...
// Ref for custom cursor Position tracking
  ...
  return (
    <div className='dark:bg-black relative'>
      ...
      <Footer theme={theme}/>
{/* Custom cursor ring */}
      <div ref={outlineRef} className='fixed top-0 left-0 h-10 w-10 rounded-full border border-primary pointer-events-none z-[50]' style={{transition: 'transform 0.1s ease-out'}}>
      </div>
      {/* Customer cursor dot */}
